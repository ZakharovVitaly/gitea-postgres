...
1	2	1	2	1	0	f		f		1542957425
2	1	1	2	1	0	f		f		1542957425
\.
...
COPY public.attachment (id, uuid, issue_id, release_id, comment_id, name, download_count, size, created_unix) FROM stdin;
\.
...
COPY public.commit_status (id, index, repo_id, state, sha, target_url, description, context, creator_id, created_unix, updated_unix) FROM stdin;
\.
...
COPY public.hook_task (id, repo_id, hook_id, uuid, type, url, payload_content, content_type, event_type, is_ssl, is_delivered, delivered, is_succeed, request_content, response_content) FROM stdin;
\.
...
COPY public.issue (id, repo_id, index, poster_id, name, content, milestone_id, priority, is_closed, is_pull, num_comments, ref, deadline_unix, created_unix, updated_unix, closed_unix) FROM stdin;
\.
...
COPY public.label (id, repo_id, name, description, color, num_issues, num_closed_issues) FROM stdin;
\.
...
COPY public.protected_branch (id, repo_id, branch_name, can_push, enable_whitelist, whitelist_user_i_ds, whitelist_team_i_ds, enable_merge_whitelist, merge_whitelist_user_i_ds, merge_whitelist_team_i_ds, created_unix, updated_unix) FROM stdin;
\.
...
1	1	1	\N	1542957425
2	1	2	{"EnableTimetracker":true,"AllowOnlyContributorsToTrackTime":true,"EnableDependencies":true}	1542957425
3	1	3	{"IgnoreWhitespaceConflicts":false,"AllowMerge":true,"AllowRebase":true,"AllowSquash":true}	1542957425
4	1	4	\N	1542957425
5	1	5	\N	1542957425
\.
...
COPY public.repository (id, owner_id, lower_name, name, description, website, default_branch, num_watches, num_stars, num_forks, num_issues, num_closed_issues, num_pulls, num_closed_pulls, num_milestones, num_closed_milestones, is_private, is_bare, is_mirror, is_fork, fork_id, size, is_fsck_enabled, topics, created_unix, updated_unix) FROM stdin;
1	2	foobar	foobar	Foo Bar		master	1	0	0	0	0	0	0	0	0	f	t	f	f	0	0	f	null	1542957425	1542957425
\.
...
1	2	owners	Owners		4	1	1
2	2	devops	DevOps	Foo Bar	2	0	2
\.
...
SELECT pg_catalog.setval('public.team_unit_id_seq', 21, true);
...
COPY public."user" (id, lower_name, name, full_name, email, keep_email_private, passwd, must_change_password, login_type, login_source, login_name, type, location, website, rands, salt, language, created_unix, updated_unix, last_login_unix, last_repo_visibility, max_repo_creation, is_active, is_admin, allow_git_hook, allow_import_local, allow_create_organization, prohibit_login, avatar, avatar_email, use_custom_avatar, num_followers, num_following, num_stars, num_repos, description, num_teams, num_members, diff_view_style) FROM stdin;
1	johndoe	JohnDoe		jdoe@example.com	f	a258a0d8822ed41e03797d95dd1d17f4a87b0ab5412f6349efeee2180f5b5ca431818ee5943f8f3dc27b4bcac95a594c29dd	f	0	0		0			xucEStOzWf	IdGJr2dHf0	en-US	1542957363	1542957363	1542957363	f	-1	t	t	f	f	t	f	694ea0904ceaf766c6738166ed89bafb	jdoe@example.com	f	0	0	0	0		0	0	
3	marysmith	MarySmith	Mary Smith	marysmith@example.com	f	2a558233f7633ef03ed9601de37e50c59b4b3b0e8032544cd7483c2b1f0449f2c6d99d8ef1bcba705e9f3cea60c3e3e5c3b9	f	0	0		0			0DKlHDgKUD	FRnbA9Abc9		1542957530	1542957553	0	f	-1	t	f	f	f	f	f	8ff47db4caf68aaf08e1b14142dfda8a	marysmith@example.com	f	0	0	0	0		0	0	
2	example.com	example.com			f		f	0	0		1		https://example.com	5OCkKnptBM	oddkNKapfB		1542957382	1542957716	0	f	-1	t	f	f	f	f	f	2		t	0	0	0	1	Example	2	2	
\.
...
--
-- Name: IDX_repository_is_bare; Type: INDEX; Schema: public; Owner: gitea
--
...
--
-- Name: UQE_access_token_sha1; Type: INDEX; Schema: public; Owner: gitea
--
